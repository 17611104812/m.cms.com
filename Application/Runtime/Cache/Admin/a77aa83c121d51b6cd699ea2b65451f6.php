            ...
            <div class="col-lg-6">
                ...
                <form class="form-horizontal" id="singcms-form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="name" class="form-control" id="inputname" value="<?php echo ($menuInfo["name"]); ?>" placeholder="请填写菜单名">
                        </div>
                    </div>
                    <!--<div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            ...
                            <input type="radio" name="type" id="optionsRadiosInline2" value="0" <?php if($menuInfo["type"] == 0): ?>checked<?php endif; ?>> 前端栏目
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="m" id="inputPassword3" value="<?php echo ($menuInfo["m"]); ?>" placeholder="模块名如admin">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-2 control-label">控制器:</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="c" id="inputPassword3" value="<?php echo ($menuInfo["c"]); ?>" placeholder="控制器如index">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-2 control-label">方法:</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="f" id="inputPassword3" value="<?php echo ($menuInfo["f"]); ?>" placeholder="方法名如index">
                        </div>
                    </div>
                    <!--<div class="form-group">
